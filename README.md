...
On Ubuntu, you may also need some system libraries:
...
If you encounter version issues with torch-geometric / torch-scatter / torch-sparse, please consult the official PyG installation guide
 and align versions with your PyTorch & CUDA stack.
